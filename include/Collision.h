...
class Collision {
	...
	public:
		...
		static inline bool IsColliding(Rect& a, Rect& b, double angleOfA, double angleOfB) {
	...
	private:
		...
		static inline double Mag(const Vec2& p) {
		...
		static inline Vec2 Rotate(const Vec2& p, double angle) {
